...
import ru.tregubowww.rick_and_morty.databinding.FragmentCharacterSearchBinding
...
class CharacterSearchFragment : Fragment(R.layout.fragment_character_search) {
    ...
    private val viewBinding by viewBinding(FragmentCharacterSearchBinding::bind)
    ...
    private fun characterSearchObserver() {

        addRepeatingJob(Lifecycle.State.STARTED) {
            viewModel.charactersFlow.collectLatest(viewModel.charactersAdapter::submitData)
        }

        viewModel.mutableSearchCharactersFromDb
