...
class FilterLocationPagingSource @AssistedInject constructor(
    private val locationService: LocationService,
    private val locationDao: LocationDao,
    @Assisted("queryFilter") private val filterQueryLocation: FilterQueryLocation,
) : PagingSource<Int, Location>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Location> {
        val page: Int = params.key ?: STARTING_PAGE_INDEX
        return try {
            val apiResponse = locationService.getLocationsFilter(
    ...
    interface Factory {
        ...
        fun create(
            @Assisted("queryFilter") filterQueryLocation: FilterQueryLocation,
        ): FilterLocationPagingSource
    }
